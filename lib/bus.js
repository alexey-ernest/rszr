...
function Bus(options) {
  ...
  /**
   * Prevents message to timeout.
   *
   * @param      {Object}  msg     Bus message.
   */
  function touchMessage(msg) {
    ...
    if (!msg.hasResponded) {
      ...
      setTimeout(touchMessage, msg.timeUntilTimeout() - 1000, msg);
    }
  }
   ...
   * @param      {Function}  fn      Callback.
   */
  this.emitImageUploaded = function (data, fn) {
   ...
   * @param      {Function}  fn      Callback.
   */
  this.emitImageResize = function (data, fn) {
